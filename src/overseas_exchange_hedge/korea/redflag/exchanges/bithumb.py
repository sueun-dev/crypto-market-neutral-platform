...
class BithumbExchange:
    ...
    def __init__(self, api_key: str, api_secret: str):
        ...
        self.session.headers.update({"Api-Key": self.api_key, "Api-Sign": "", "Api-Nonce": ""})
    ...
    def _create_signature(self, endpoint: str, params: Dict) -> Dict:
        ...
        # Create signature
        signature = hmac.new(self.api_secret.encode("utf-8"), data.encode("utf-8"), hashlib.sha512).hexdigest()
    ...
    def get_ticker(self, symbol: str) -> Optional[Dict]:
        ...
        try:
            ...
            orderbook_data = self._public_api_call("orderbook", {"order_currency": base, "payment_currency": quote})

            # Get ticker for last price
            ticker_data = self._public_api_call("ticker", {"order_currency": base, "payment_currency": quote})
    ...
    def get_balance(self, currency: str) -> Optional[Dict]:
        ...
        try:
            ...
            if data:
                ...
                return {"free": available, "used": in_use, "total": total}
